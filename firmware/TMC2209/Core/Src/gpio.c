...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, Z_DIR_Pin|Y_DIR_Pin|X_DIR_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : Z_DIR_Pin Y_DIR_Pin X_DIR_Pin */
  GPIO_InitStruct.Pin = Z_DIR_Pin|Y_DIR_Pin|X_DIR_Pin;
  ...
  /*Configure GPIO pins : PB12 ENABLE_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_12|ENABLE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
